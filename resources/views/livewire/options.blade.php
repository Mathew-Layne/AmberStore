...
<div class="w-full overflow-hidden rounded-lg shadow-xs">
    ...
    <div class="flex justify-between">
        ...
        <span class="flex justify-end m-2">
            <x-table.button wire:click="$set('addValue', true)" color="blue"
        ...
        <table class="w-full">
            ...
            <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                ...
                <tr
                    ...
                    <td class="px-4 py-3 text-sm flex space-x-2">
                        <x-table.button wire:click="viewOption({{ $value->id }})" color="blue" class="py-2 px-4">View
                        </x-table.button>
                        <x-table.button wire:click="deleteOption({{ $value->id }})" color="red" class="py-2 px-4">Delete
                        </x-table.button>
